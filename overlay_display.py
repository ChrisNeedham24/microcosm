...
def display_overlay(overlay: Overlay, is_night: bool):
    ...
    # player's units.
        ...
        if OverlayType.CONTROLS in overlay.showing:
            ...
            pyxel.text(30, 55, "CTRL + ", pyxel.COLOR_WHITE)
            pyxel.text(30, 65, "ARROWS", pyxel.COLOR_WHITE)
            pyxel.text(65, 60, "Fast scroll the map", pyxel.COLOR_WHITE)
            pyxel.text(30, 75, "R CLICK", pyxel.COLOR_WHITE)
            pyxel.text(65, 75, "Show quad yield", pyxel.COLOR_WHITE)
            pyxel.text(30, 85, "L CLICK", pyxel.COLOR_WHITE)
            pyxel.text(65, 85, "Move/select/attack units", pyxel.COLOR_WHITE)
            pyxel.text(30, 95, "C", pyxel.COLOR_WHITE)
            pyxel.text(65, 95, "Add/change construction", pyxel.COLOR_WHITE)
            pyxel.text(30, 105, "F", pyxel.COLOR_WHITE)
            pyxel.text(65, 105, "Add/change blessing", pyxel.COLOR_WHITE)
            pyxel.text(30, 115, "D", pyxel.COLOR_WHITE)
            pyxel.text(65, 115, "Deploy/disband unit", pyxel.COLOR_WHITE)
            pyxel.text(30, 125, "N", pyxel.COLOR_WHITE)
            pyxel.text(65, 125, "Next song", pyxel.COLOR_WHITE)
            pyxel.text(30, 135, "B", pyxel.COLOR_WHITE)
            pyxel.text(65, 135, "Buyout construction", pyxel.COLOR_WHITE)
