...
class MoveUnitEvent(UpdateEvent):
    ...
    """
    initial_loc: (int, int)  # Used to identify the unit being moved.
    new_loc: (int, int)
...
class DeployUnitEvent(UpdateEvent):
    ...
    """
    settlement_name: str
    location: (int, int)  # Refers to the deployed unit's location.
...
class GarrisonUnitEvent(UpdateEvent):
    ...
    """
    initial_loc: (int, int)  # Used to identify the unit being garrisoned.
...
class InvestigateEvent(UpdateEvent):
    ...
    """
    unit_loc: (int, int)  # Used to identify the unit investigating the relic.
    relic_loc: (int, int)
...
class BesiegeSettlementEvent(UpdateEvent):
    ...
    """
    unit_loc: (int, int)  # Used to identify the unit placing the settlement under siege.
    settlement_name: str
...
class DisbandUnitEvent(UpdateEvent):
    ...
    """
    location: (int, int)  # Used to identify the unit being disbanded.
...
class AttackUnitEvent(UpdateEvent):
    ...
    """
    attacker_loc: (int, int)  # Used to identify the attacking unit.
    defender_loc: (int, int)  # Used to identify the defending unit.
...
class HealUnitEvent(UpdateEvent):
    ...
    """
    healer_loc: (int, int)  # Used to identify the healer unit.
    healed_loc: (int, int)  # Used to identify the unit being healed.
...
class BoardDeployerEvent(UpdateEvent):
    ...
    """
    initial_loc: (int, int)  # Used to identify the unit boarding the deployer unit.
    deployer_loc: (int, int)  # Used to identify the deployer unit.
    # The logic to subtract stamina happens client-side, so we need to update the server and other clients with the
    # changes.
    new_stamina: int
