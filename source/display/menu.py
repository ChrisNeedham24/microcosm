...
class Menu:
    ...
    def __init__(self):
        ...
        """
        self.main_menu_option: MainMenuOption = MainMenuOption.NEW_GAME
        random.seed()
        self.image_bank: int = random.randint(0, 5)
        self.in_game_setup: bool = False
        self.loading_game: bool = False
        self.in_wiki: bool = False
        self.wiki_option: WikiOption = WikiOption.VICTORIES
        self.wiki_showing: Optional[WikiOption] = None
        self.victory_type: VictoryType = VictoryType.ELIMINATION
        self.blessing_boundaries: Tuple[int, int] = 0, 3
        self.improvement_boundaries: Tuple[int, int] = 0, 3
        self.unit_boundaries: Tuple[int, int] = 0, 8
        self.saves: List[SaveDetails] = []
        self.save_idx: Optional[int] = 0
        self.setup_option: SetupOption = SetupOption.PLAYER_FACTION
        self.faction_idx: int = 0
        self.player_count: int = 2
        self.multiplayer_status: MultiplayerStatus = MultiplayerStatus.DISABLED
        self.biome_clustering_enabled: bool = True
        self.fog_of_war_enabled: bool = True
        self.climatic_effects_enabled: bool = True
        self.showing_night: bool = False
        self.faction_colours: List[Tuple[Faction, int]] = list(FACTION_COLOURS.items())
        self.showing_faction_details: bool = False
        self.faction_wiki_idx: int = 0
        self.load_game_boundaries: Tuple[int, int] = 0, 4
        self.load_failed: bool = False
        self.viewing_stats: bool = False
        ...
        self.viewing_achievements: bool = False
        self.achievements_boundaries: Tuple[int, int] = 0, 3
        self.showing_rare_resources: bool = False
        self.multiplayer_lobby: Optional[LobbyDetails] = None
        self.viewing_lobbies: bool = False
        self.viewing_local_lobbies: bool = False
        self.multiplayer_lobbies: List[LobbyDetails] = []
        self.lobby_index: int = 0
        self.joining_game: bool = False
        self.available_multiplayer_factions: List[Tuple[Faction, int]] = []
        self.lobby_player_boundaries: Tuple[int, int] = 0, 7
